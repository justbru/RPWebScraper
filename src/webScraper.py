...
if __name__ == '__main__':
    ...
    driver = webdriver.Firefox(executable_path=r'C:\Users\jbrun\PycharmProjects\RPWebScraper\geckodriver.exe',
                               options=options)
    ...
    with open('src/testGroup.csv') as csv_file:
        ...
        for row in csv_reader:
            ...
            df.to_csv(r"Desired Path to Save the File to", index=False)
            line_count += 1
